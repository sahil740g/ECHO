...
const AuthModal = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // login(); // Email login not yet implemented
    alert("Please use Google or GitHub to login.");
    // onClose();
  };
    ...
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-[100] backdrop-blur-sm">
      <div className="bg-[#161b22] border border-white/10 rounded-xl w-full max-w-md p-8 shadow-2xl relative animate-in fade-in zoom-in duration-200">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full bg-blue-600 hover:bg-blue-500 text-white py-2.5 rounded-lg font-medium transition cursor-pointer mt-2"
          >
